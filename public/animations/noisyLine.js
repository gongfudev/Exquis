...
if( this.frameCount % 2 == 0) {
	...
	this.xstart += (lib.noise.perlin2( this.xstartNoise, 0) * 0.5) - 0.25;
	this.ystart += (lib.noise.perlin2( this.ystartNoise, 0) * 0.5) - 0.25;
	...
	for( var y = 0; y <= this.height; y += 15) {
	    ...
	    for( var x = 0; x <= this.width; x+= 15) {
	      xnoise += 0.1;
	      this.drawLine( x, y, lib.noise.perlin2( xnoise, ynoise));
	    };
	};
};
},
